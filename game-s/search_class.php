...
<body>
    ...
    <div class="container-fluid"  style="margin:0px 0px 53px 0px;">
        ...
        <div class="table-responsive">
        	<center><h3><?php  $class = $_GET['class'];echo "{$class}";?>成绩详情</h3></center>
        ...
        //3.执行sql语句，并实现解析和遍历
		$a=0;
		$sql = "SELECT * FROM ranking where class='{$class}' ORDER BY score DESC";
		...
		foreach ($s as $c){
            ...
            <p><strong>备注：</strong>点击姓名获取个人得分详细信息</p>
        </div>
    </div>
</body>
